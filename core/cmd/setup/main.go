// cmd/setup/main.go
// Tollgate setup wizard — run once after cloning.
...
func buildEnv() string {
	lines := []string{
		"# Tollgate Notary — Environment Configuration",
		...
		"# Production: inject TOLLGATE_SIGNING_KEY_HEX via secrets manager instead.",
